...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of monero birth 2022-01-02 15:19:04 (1641136744)
    var moneroBirthTime = _nettype == "Mainnet" ? 1641136744 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    // avg seconds per block in v1
    var secondsPerBlockV1 = 60;
    // time of v2 fork 2022-01-02 15:35:35 (1641137735)
    var forkTime = _nettype == "Mainnet" ? 1641137735 : _nettype == "Testnet" ? 1448285909 : 1520937818;
    // v2 fork block
    var forkBlock = _nettype == "Mainnet" ? 1641138030 : _nettype == "Testnet" ? 624634 : 32000;
